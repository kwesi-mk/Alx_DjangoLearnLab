...
SECRET_KEY = 'django-insecure-8n4m^#i*z@k(95=)x45p--#9ne2tl33)m6zaw7-)jxo*5vk4uk'
...
#Disable Django's default error reporting in production ( use a proper logging system)
